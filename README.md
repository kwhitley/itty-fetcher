...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(t,n,s=("string"==typeof t?{base:t,...n}:t||{}),{base:o=("undefined"!=typeof window?window?.location?.origin??"":""),headers:r={},...i}=s)=>new Proxy(((...t)=>e(...t)),{get:(e,t)=>e[t]??((...e)=>(async(e,t,n,s,o,r=("string"==typeof t[0]?t.shift():""),i=("get"!=e?t.shift():null),a=new Headers(o))=>{n={...n,...t.shift(),method:e};let f=new URL((d=~r.indexOf("http")?r:s+("/"==s.slice(-1)&&"/"==r[0]?r.slice(1):r))&&(~d.indexOf("http")||~s.indexOf("http"))?d:"http://localhost"+("/"==d[0]?d:"/"+d));var d;for(let[e,t]of Object.entries(n.query||{}))f.searchParams.append(e,t);i&&(n.body=!1===n.encode||"string"==typeof i?i:JSON.stringify(i),!1!==n.encode&&"string"!=typeof i&&a.set("content-type","application/json"));for(let[e,t]of[...new Headers(n.headers??[])])a.set(e,t);let c,p=await(n.fetch??fetch)(new Request(f,{...n,headers:a}));if(!p.ok&&(c=Object.assign(new Error(p.statusText),{status:p.status})),!1!==n.parse&&(p=await(p.headers.get("content-type")?.includes("json")?p.json():p.text())),c)return n.onError?n.onError(c,p):Promise.reject(c);for(let e of n.after||[]){let t=await e(p);void 0!==t&&(p=t)}return p})(t,e,i,o,r))});
```
<!-- END SNIPPET -->
