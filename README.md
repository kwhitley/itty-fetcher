...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(t,n,s=("string"==typeof t?{base:t,...n}:t||{}),{base:o=("undefined"!=typeof window?window?.location?.origin??"":""),headers:r={},...i}=s)=>new Proxy(((...t)=>e(...t)),{get:(e,t)=>e[t]??((...e)=>(async(e,t,n,s,o)=>{let r="string"==typeof t[0]?t.shift():"",i="get"!=e?t.shift():null;n={...n,...t.shift(),method:e},o=new Headers(o);let a=new URL((f=~r.indexOf("http")?r:s+("/"==s.slice(-1)&&"/"==r[0]?r.slice(1):r))&&(~f.indexOf("http")||~s.indexOf("http"))?f:"http://localhost"+("/"==f[0]?f:"/"+f));var f;for(let[e,t]of Object.entries(n.query||{}))a.searchParams.append(e,t);i&&(n.body=!1===n.encode||"string"==typeof i?i:JSON.stringify(i),!1!==n.encode&&"string"!=typeof i&&o.set("content-type","application/json"));for(let[e,t]of[...new Headers(n.headers??[])])o.set(e,t);let d,c=await(n.fetch??fetch)(new Request(a,{...n,headers:o}));if(!c.ok&&(d=Object.assign(new Error(c.statusText),{status:c.status})),!1!==n.parse&&(c=await(c.headers.get("content-type")?.includes("json")?c.json():c.text())),d)return n.onError?n.onError(d,c):Promise.reject(d);for(let e of n.after||[]){let t=await e(c);void 0!==t&&(c=t)}return c})(t,e,i,o,r))});
```
<!-- END SNIPPET -->
