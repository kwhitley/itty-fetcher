...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,t)=>{let s="string"==typeof e?{base:e,...t}:e||{},{base:o=globalThis.location?.origin||"",headers:r={},...n}=s,a=(e,...t)=>(async(e,t,s,o,r,n=("string"==typeof t[0]?t.shift():""),a=("get"!=e?t.shift():null))=>{let i=new URL(n,n.includes("://")?void 0:o||globalThis.location?.href),l={...s,...t.shift(),method:e},f=new Headers(r);for(let e in l.query||{})i.searchParams.append(e,l.query[e]);if(a){let e="string"==typeof a;l.body=0==l.encode||e?a:JSON.stringify(a),!e&&!1!==l.encode&&f.set("content-type","application/json")}for(let[e,t]of new Headers(l.headers||[]))f.set(e,t);let c=await(l.fetch||fetch)(new Request(i,{...l,headers:f})),d=!c.ok&&Object.assign(new Error(c.statusText),{status:c.status});if(!1!==l.parse&&(c=await(c.headers.get("content-type")?.includes("json")?c.json():c.text())),d)return l.onError?.(d,c)||Promise.reject(d);for(let e of l.after||[]){let t=await e(c);void 0!==t&&(c=t)}return c})(e,t,n,o,r),i=(...e)=>a("get",...e);for(let e of["get","post","put","patch","delete"])i[e]=(...t)=>a(e,...t);return i};
```
<!-- END SNIPPET -->
