...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,t)=>{let s="string"==typeof e?{base:e,...t}:e||{},{base:a=globalThis.location?.origin||"",headers:o={},...r}=s,n=(e,...t)=>(async(e,t,s,a,o,r=("string"==typeof t[0]?t.shift():""),n=("GET"!=e?t.shift():null))=>{let i=new URL(r,r.includes("://")?void 0:a||globalThis.location?.href),f={...s,...t.shift(),method:e},l=new Headers(o),p=f.parse??"json",c="json"===p;for(let e in f.query||{})i.searchParams.append(e,f.query[e]);if(n){let e="string"==typeof n;f.body=0==f.encode||e?n:JSON.stringify(n),!e&&0!=f.encode&&l.set("content-type","application/json")}for(let[e,t]of new Headers(f.headers||[]))l.set(e,t);let g=await(f.fetch||fetch)(new Request(i,{...f,headers:l})),d=g.ok?void 0:Object.assign(new Error(g.statusText),{status:g.status,response:g});if(p){let e;try{e=g=await g[p](),d&&(c?(d={...d,...e},d.message=e.message??d.message):d.message=e??d.message)}catch(e){!d&&(d=Object.assign(new Error(e.message),{status:g.status,response:g}))}}for(let e of f.after||[]){let t=await e(g);void 0!==t&&(g=t)}if(f.tuple)return[d,d?void 0:g];if(d)throw d;return g})(e,t,r,a,o),i=(...e)=>n("get",...e);for(let e of["get","post","put","patch","delete"])i[e]=(...t)=>n(e.toUpperCase(),...t);return i};
```
<!-- END SNIPPET -->
