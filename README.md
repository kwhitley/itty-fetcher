...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,t)=>{let s="string"==typeof e?{base:e,...t}:e||{},{base:o=globalThis.location?.origin||"",headers:n={},...r}=s,a=(e,...t)=>(async(e,t,s,o,n,r=("string"==typeof t[0]?t.shift():""),a=("get"!=e?t.shift():null))=>{let i=new URL(r,r.includes("://")?void 0:o||globalThis.location?.href),l={...s,...t.shift(),method:e},f=new Headers(n);for(let e in l.query||{})i.searchParams.append(e,l.query[e]);if(a){let e="string"==typeof a;l.body=0==l.encode||e?a:JSON.stringify(a),!e&&!1!==l.encode&&f.set("content-type","application/json")}for(let[e,t]of new Headers(l.headers||[]))f.set(e,t);let p=await(l.fetch||fetch)(new Request(i,{...l,headers:f})),c=!p.ok&&Object.assign(new Error(p.statusText),{status:p.status,response:p});if(c){if(l.tuple)return l.tuple;throw c}!1!==l.parse&&(p=await(p.headers.get("content-type")?.includes("json")?p.json():p.text()));for(let e of l.after||[]){let t=await e(p);void 0!==t&&(p=t)}return l.tuple?[p,c]:p})(e,t,r,o,n),i=(...e)=>a("get",...e);for(let e of["get","post","put","patch","delete"])i[e]=(...t)=>a(e,...t);return i};
```
<!-- END SNIPPET -->
