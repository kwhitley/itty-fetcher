...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,s)=>{let t="string"==typeof e?{base:e,...s}:e||{};return new Proxy((()=>{}),{get:(e,s)=>(...e)=>(async(e,s,t,a="",r=s.shift()??"",n=("GET"!=e?s.shift():null))=>{r=new URL((r.includes("://")?r:(a.includes("://")?a:globalThis.location?.href+"/"+a)+(r?"/"+r:"")).replace(/\/+/g,"/"));let o={...t,...s.shift(),method:e},i=new Headers(t.headers||{}),f=o.parse??"json",l="string"==typeof n;for(let e in o.query||{})r.searchParams.append(e,o.query[e]);n&&(o.body=0==o.encode||l?n:JSON.stringify(n),!l&&0!=o.encode&&i.set("content-type","application/json"));for(let[e,s]of new Headers(o.headers||[]))i.set(e,s);let c=await(o.fetch||fetch)(new Request(r,{...o,headers:i})),u=c.ok?void 0:Object.assign(new Error(c.statusText),{status:c.status,response:c});if(f)try{c=c=await c[f](),u&&("json"===f?(u={...u,...c},u.message=c.message??u.message):u.message=c??u.message)}catch(e){!u&&(u=Object.assign(new Error(e.message),{status:c.status,response:c}))}for(let e of o.after||[]){let s=await e(c);null!=s&&(c=s)}if(o.array)return[u,u?void 0:c];if(u)throw u;return c})(s.toUpperCase(),e,t,t.base)})};
```
<!-- END SNIPPET -->
