...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,t)=>{let s="string"==typeof e?{base:e,...t}:e||{},{base:a=globalThis.location?.origin||"",headers:o={},...r}=s,n=(e,...t)=>(async(e,t,s,a,o,r=("string"==typeof t[0]?t.shift():""),n=("get"!=e?t.shift():null))=>{let i=new URL(r,r.includes("://")?void 0:a||globalThis.location?.href),l={...s,...t.shift(),method:e},f=new Headers(o);l.as=l.as??"json";for(let e in l.query||{})i.searchParams.append(e,l.query[e]);if(n){let e="string"==typeof n;l.body=0==l.encode||e?n:JSON.stringify(n),!e&&0!=l.encode&&f.set("content-type","application/json")}for(let[e,t]of new Headers(l.headers||[]))f.set(e,t);let c=await(l.fetch||fetch)(new Request(i,{...l,headers:f})),g=c.ok?void 0:Object.assign(new Error(c.statusText),{status:c.status,response:c});if(!1!==l.parse)try{let e=l.as;"json"===e&&!c.headers.get("content-type")?.includes("json")&&(e="text");let t=await c[e]();g?"json"===e?(g={...g,...t},g.message=t.message??g.message):g.message=t??g.message:c=t}catch(e){!g&&(g=Object.assign(new Error(e?.message||"Parse error"),{status:c.status,response:c}))}for(let e of l.after||[]){let t=await e(c);void 0!==t&&(c=t)}if(l.tuple)return[g,g?void 0:c];if(g)throw g;return c})(e,t,r,a,o),i=(...e)=>n("get",...e);for(let e of["get","post","put","patch","delete"])i[e]=(...t)=>n(e,...t);return i};
```
<!-- END SNIPPET -->
