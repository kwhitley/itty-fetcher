...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,t)=>{let s="string"==typeof e?{base:e,...t}:e||{},{base:a=globalThis.location?.origin||"",headers:o={},...r}=s,n=(e,...t)=>(async(e,t,s,a,o,r=("string"==typeof t[0]?t.shift():""),n=("GET"!=e?t.shift():null))=>{let i=new URL(r,r.includes("://")?void 0:a||globalThis.location?.href),f={...s,...t.shift(),method:e},l=new Headers(o),p=f.parse??"json";for(let e in f.query||{})i.searchParams.append(e,f.query[e]);if(n){let e="string"==typeof n;f.body=0==f.encode||e?n:JSON.stringify(n),!e&&0!=f.encode&&l.set("content-type","application/json")}for(let[e,t]of new Headers(f.headers||[]))l.set(e,t);let c=await(f.fetch||fetch)(new Request(i,{...f,headers:l})),d=c.ok?void 0:Object.assign(new Error(c.statusText),{status:c.status,response:c});if(p){let e;try{e=await c[p](),d?"json"===parseMethod?(d={...d,...e},d.message=e.message??d.message):d.message=e??d.message:(e=c.text(),c=e)}catch(e){!d&&(d=Object.assign(new Error(e.message),{status:c.status,response:c}))}}for(let e of f.after||[]){let t=await e(c);void 0!==t&&(c=t)}if(f.tuple)return[d,d?void 0:c];if(d)throw d;return c})(e,t,r,a,o),i=(...e)=>n("get",...e);for(let e of["get","post","put","patch","delete"])i[e]=(...t)=>n(e.toUpperCase(),...t);return i};
```
<!-- END SNIPPET -->
