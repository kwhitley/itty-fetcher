...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,s,r=("string"==typeof e?{base:e,...s}:e||{}),{base:n=("undefined"!=typeof window?window?.location?.origin??"":""),headers:o={},...a}=r)=>new Proxy(((...e)=>t(...e)),{get:(t,e)=>t[e]??((...t)=>(async(t,e,s,r,n)=>{let o="string"==typeof e[0]?e.shift():"",a="get"!=t?e.shift():null;s={...s,...e.shift(),method:t},n=new Headers(n);let i=-1===o.indexOf("http")?r+(r.endsWith("/")&&o.startsWith("/")?o.slice(1):o):o;i&&(i.startsWith("http")||r.startsWith("http"))||(i="http://localhost"+(i.startsWith("/")?i:"/"+i));let f=new URL(i);for(let[t,e]of Object.entries(s.query||{}))f.searchParams.append(t,e);a&&(s.body=!1===s.encode||"string"==typeof a?a:JSON.stringify(a),!1!==s.encode&&"string"!=typeof a&&n.set("content-type","application/json"));for(let[t,e]of[...new Headers(s.headers??[])])n.set(t,e);let h,d=await(s.fetch??fetch)(new Request(f,{...s,headers:n}));if(!d.ok&&(h=Object.assign(new Error(d.statusText),{status:d.status})),!1!==s.parse&&(d=await(d.headers.get("content-type")?.includes("json")?d.json():d.text())),h)return s.onError?s.onError(h,d):Promise.reject(h);for(let t of s.after||[]){let e=await t(d);void 0!==e&&(d=e)}return d})(e,t,a,n,o))});
```
<!-- END SNIPPET -->
