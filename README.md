...
<!-- BEGIN SNIPPET -->
```ts
let e=(e,t)=>{let o="string"==typeof e?{base:e,...t}:e||{},{base:r=("undefined"!=typeof window?window?.location?.origin??"":""),headers:s={},...n}=o,a=(e,...t)=>(async(e,t,o,r,s,n=("string"==typeof t[0]?t.shift():""),a=("get"!=e?t.shift():null),i=new Headers(s),f={...o,...t.shift(),method:e})=>{let d=new URL(n,n.includes("://")?n:r||globalThis.location?.href);for(let[e,t]of Object.entries(f.query||{}))d.searchParams.append(e,t);a&&(f.body=0==f.encode||"string"==typeof a?a:JSON.stringify(a),!1!==f.encode&&"string"!=typeof a&&i.set("content-type","application/json"));for(let[e,t]of[...new Headers(f.headers??[])])i.set(e,t);let l,c=await(f.fetch??fetch)(new Request(d,{...f,headers:i}));if(!c.ok&&(l=Object.assign(new Error(c.statusText),{status:c.status})),!1!==f.parse&&(c=await(c.headers.get("content-type")?.includes("json")?c.json():c.text())),l)return f.onError?f.onError(l,c):Promise.reject(l);for(let e of f.after||[]){let t=await e(c);void 0!==t&&(c=t)}return c})(e,t,n,r,s),i=(...e)=>a("get",...e);for(let e of["get","post","put","patch","delete"])i[e]=(...t)=>a(e,...t);return i};
```
<!-- END SNIPPET -->
