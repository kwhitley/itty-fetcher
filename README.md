...
<!-- BEGIN SNIPPET -->
```ts
let e=(e,t)=>{let r="string"==typeof e?{base:e,...t}:e||{},{base:s=globalThis?.location?.origin||"",headers:o={},...n}=r,a=(e,...t)=>(async(e,t,r,s,o,n=("string"==typeof t[0]?t.shift():""),a=("get"!=e?t.shift():null),i=new Headers(o),f={...r,...t.shift(),method:e})=>{let l=new URL(n,n.includes("://")?n:s||globalThis.location?.href);for(let[e,t]of Object.entries(f.query||{}))l.searchParams.append(e,t);a&&(f.body=0==f.encode||"string"==typeof a?a:JSON.stringify(a),!1!==f.encode&&"string"!=typeof a&&i.set("content-type","application/json"));for(let[e,t]of[...new Headers(f.headers??[])])i.set(e,t);let c,d=await(f.fetch??fetch)(new Request(l,{...f,headers:i}));if(!d.ok&&(c=Object.assign(new Error(d.statusText),{status:d.status})),!1!==f.parse&&(d=await(d.headers.get("content-type")?.includes("json")?d.json():d.text())),c)return f.onError?f.onError(c,d):Promise.reject(c);for(let e of f.after||[]){let t=await e(d);void 0!==t&&(d=t)}return d})(e,t,n,s,o),i=(...e)=>a("get",...e);for(let e of["get","post","put","patch","delete"])i[e]=(...t)=>a(e,...t);return i};
```
<!-- END SNIPPET -->
