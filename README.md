...
<!-- BEGIN SNIPPET -->
```ts
let fetcher=(e,t)=>{let s="string"==typeof e?{base:e,...t}:e||{};return new Proxy((()=>{}),{get:(e,t)=>(...e)=>(async(e,t,s,r=("string"==typeof s[0]?s.shift():""),a=("GET"!=e?s.shift():null),n={...t,...s.shift(),method:e},o=new Headers(t.headers),i="string"==typeof a,f=t.base??"")=>{r=new URL((r.includes("://")?r:(f.includes?.("://")?f:globalThis.location?.href+"/"+f)+(r?"/"+r:"")).replace(/\/+/g,"/"));for(let e in n.query||{})r.searchParams.append(e,n.query[e]);a&&(n.body=0!=n.encode?i?a:JSON.stringify(a):a,!i&&0!=n.encode&&o.set("content-type","application/json"));for(let[e,t]of new Headers(n.headers||[]))o.set(e,t);let c=await(n.fetch||fetch)(new Request(r,{...n,headers:o})),l=c.ok?void 0:Object.assign(new Error(c.statusText),{status:c.status,response:c});if(n.parse??"json")try{c=await c[n.parse??"json"](),l&&"json"==(n.parse??"json")&&(l={...l,...c})}catch(e){!l&&(l=Object.assign(new Error(e.message),{status:c.status,response:c}))}for(let e of n.after||[]){let t=await e(c);null!=t&&(c=t)}if(n.array)return[l,l?void 0:c];if(l)throw l;return c})(t.toUpperCase(),s,e)})};
```
<!-- END SNIPPET -->
